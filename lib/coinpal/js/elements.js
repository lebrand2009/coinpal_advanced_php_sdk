...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    ...
    <ul class="navbar-nav ml-auto">
	  ...
	  <span id="logoutinj">	
	  <li class="nav-item"><span class="nav-link"><a style="color:white;" href="?logout=1"><button type="button" class="btn btn-danger btn-sm"> <i class="fas fa-sign-out-alt"></i><span class="badge text-bg-secondary">Log Out</span></button></a></span>
	  </li>
	  </span>	
	</ul>
  </div>
