...
document.addEventListener("DOMContentLoaded", function() {
	...
	const loginEl = document.createElement("span"); 
	      loginEl.innerHTML = loginElement;
		
	const logoutEl = document.createElement("span"); 
	      logoutEl.innerHTML = logoutElement;	
		
	const userSetupEl = document.createElement("span"); 
	      userSetupEl.innerHTML = userSetupElement;		
		
	const resetUserEl = document.createElement("span"); 
	      resetUserEl.innerHTML = resetUserElement;
    ...
    xhr.onreadystatechange = function() {
        if (xhr.readyState == XMLHttpRequest.DONE) {
            if (xhr.status == 200) {
                ...
                createForm(ajaxedHTML, userSetupEl, loginEl, logoutEl, resetUserEl);
            } else {
	...
	/* ELEMENTS INJECTION & DATA END */
	
	

    function createForm(ajaxedHTML, userSetupEl, loginEl, logoutEl, resetUserEl) {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("GET", "/lib/coinpal/login.php", true);
    xhr.onreadystatechange = function() {
        if (xhr.readyState === XMLHttpRequest.DONE) {
            if (xhr.status === 200) {
  ...
  function handleResponseStatus(status) { 
	...
	document.getElementById("logoutinj").innerHTML = logoutEl.innerHTML;  
	
    function checkElementlogoutLoaded() {
        var logoutElement = document.getElementById("logoutbutton");
        if (logoutElement) {
            logoutElement.addEventListener("click", function(event) {
            event.preventDefault();
            var params = "logout=1";	
            var xhr = new XMLHttpRequest();
            xhr.open("POST", fullUrl + "/lib/coinpal/login.php", true);
            ...
            xhr.onload = function() {
                if (xhr.status == 200) {
					...
					informTheUser('User Logout', responseText, 'action');
				    handleResponseStatus(responseStatus);
                }
            };
            xhr.send(params);
            ...
            setTimeout(checkElementlogoutLoaded, 100);
        }
    }		
		
    checkElementlogoutLoaded();		
	...
	document.getElementById("logoutinj").innerHTML = '';
	...
	document.getElementById("resetuserinj").innerHTML = resetUserEl.innerHTML;
		
        var userResetElement = document.getElementById("buttonresetuser");
            userResetElement.addEventListener("click", function(event) {
            event.preventDefault();
            var params = "userreset=1";	
            var xhr = new XMLHttpRequest();
            xhr.open("POST", fullUrl + "/lib/coinpal/login.php", true);
            xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xhr.onload = function() {
                if (xhr.status == 200) {
                    ...
                    responseStatus = response.status;
					responseText = response.text;
					informTheUser('User Reset', responseText, 'action');
				    handleResponseStatus(responseStatus);
                }
            };
            xhr.send(params);
	...
	document.getElementById("resetuserinj").innerHTML = '';	
    ...
    formHtml = userSetupEl.innerHTML;
    ...
    function checkElementusersetupLoaded() {
        var usersetupElement = document.getElementById("usersetup");
        if (usersetupElement) {
            usersetupElement.addEventListener("submit", function(event) {
            event.preventDefault();
			var username = document.getElementById("setup_username").value;
            var password = document.getElementById("setup_password").value;
            var params = "setup_username=" + encodeURIComponent(username) +
                         "&setup_password=" + encodeURIComponent(password);	
            var xhr = new XMLHttpRequest();
            xhr.open("POST", fullUrl + "/lib/coinpal/login.php", true);
            xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xhr.onload = function() {
                if (xhr.status == 200) {
                    ...
                    responseStatus = response.status;
					responseText = response.text;
					informTheUser('User Setup', responseText, 'reload');
                }
            };
            xhr.send(params);
        });
        } else {
            setTimeout(checkElementusersetupLoaded, 100);
        }
    }		
		
    checkElementusersetupLoaded();						
    ...
    function checkElementloginLoaded() {
        ...
        if (loginElement) {
            ...
            xhr.onload = function() {
                if (xhr.status == 200) {
                    ...
                    responseStatus = response.status;
					responseText = response.text;
					informTheUser('User Login', responseText, 'action');
				    handleResponseStatus(responseStatus);
                }
            };
            xhr.send(params);
            ...
            setTimeout(checkElementloginLoaded, 100);
        }
    }		
		
    checkElementloginLoaded();						
    ...
    function checkElementcheckconnLoaded() {
        var checkconnElement = document.getElementById("checkconn");
        if (checkconnElement) {
            checkconnElement.addEventListener("click", function() {
                if (checkFieldsFilled()) {
                    ...
                    xhr.onreadystatechange = function() {
                        if (xhr.readyState == 4 && xhr.status == 200) {
                            ...
                            informTheUser('DB Settings', result, 'action');
                        }
                    };
                    xhr.send(params);
                } else {
                    informTheUser('DB Settings', 'Please fill all database fields', 'action');
                }
            });
        } else {
            setTimeout(checkElementcheckconnLoaded, 100);
        }
    }
  
    checkElementcheckconnLoaded();		

		
    function checkElementcoinpalsetupLoaded() {
        var coinpalsetupElement = document.getElementById("coinpalsetup");
        if (coinpalsetupElement) {
            coinpalsetupElement.addEventListener("submit", function(event) {		
            event.preventDefault();
            ...
            xhr.onload = function() {
                if (xhr.status == 200) {
					...
					informTheUser('Settings', respText, 'action');
					handleResponseStatus(respStatus);
                }
            };
            xhr.send(new URLSearchParams(formData));
        });
        } else {
            setTimeout(checkElementcoinpalsetupLoaded, 100);
        }
    }		
		
    checkElementcoinpalsetupLoaded();	
    ...
    } // END function handleResponseStatus
		

		
		
    function informTheUser(modalTitle, modalText, action) {
